...
RootModule = 'Arcus.Scripting.ACR.psm1'

# Version number of this module.
ModuleVersion = '#{Package.Version}#'

# ID used to uniquely identify this module
GUID = '23ef65cb-2de3-4ece-8ba7-209d84d04145'
...
Description = 'Scripts related to Azure Container Registry'
...
RequiredModules = @(@{ModuleName='Az.ContainerRegistry'; ModuleVersion='2.2.3'})
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure','ACR', 'Containers', 'Arcus'
